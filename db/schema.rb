...
ActiveRecord::Schema.define(version: 20160920211030) do
  ...
  create_table "projects", force: :cascade do |t|
    ...
    t.string   "main_wireframe_file_name"
    t.string   "main_wireframe_content_type"
    t.integer  "main_wireframe_file_size"
    t.datetime "main_wireframe_updated_at"
    t.string   "mobile_wireframe_file_name"
    t.string   "mobile_wireframe_content_type"
    t.integer  "mobile_wireframe_file_size"
    t.datetime "mobile_wireframe_updated_at"
